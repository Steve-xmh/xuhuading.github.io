...
jQuery(document).ready(function ($) {
    $("#spig").mousedown(function (e) {
        if(e.which==3){
        showMessage("秘密通道:<br /><a href=\"http://www.xuhuading.cn/bigxigua\" title=\"订阅\">订阅</a>    <a href=\"http://www.xuhuading.cn/\" title=\"首页\">首页</a>",10000);
}
});
...
jQuery(document).ready(function ($) {
    if (isindex) { //如果是主页
        ...
        showMessage('欢迎' + visitor + '来到AlphaStudio官方网站', 6000);
    }
    $(".spig").animate({
