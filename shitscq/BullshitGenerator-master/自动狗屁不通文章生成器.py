...
名人名言 = """爱迪生a，天才是百分之一的勤奋加百分之九十九的汗水。b,
    ...
    吉格·金克拉a, 如果你能做梦，你就能实现它。b""" # a 代表前面垫话，b代表后面垫话
前面垫话 = """曾经说过,
    在不经意间这样说过,
    说过一句著名的话,
    说过一句著名的话,
    曾经提到过,
    说过一句富有哲理的话""" # 在名人名言前面弄点废话
后面垫话 = """这不禁令我深思. ,
    ...
    这似乎解答了我的疑惑."""  # 在名人名言后面弄点废话
废话 = """现在, 解决x的问题, 是非常非常重要的. 所以, ,
    ...
    对我个人而言，x不仅仅是一个重大的事件，还可能会改变我的人生. """ # 代表文章主要废话来源
