...
function add() {
    ...
    $.ajax({
        ...
        error:function(){
            showMessage("网络出现问题了呢，如有问题尽快反馈http://www.xuhuading.cn/QQ", 6000);
        }
    });
    }
...
re.toString = function() {
    showMessage('你打开了控制台，是准备偷看我秘密了是吧？徐华玎告诉你：没门！代码是压缩过的，你复制去吧！（按Ctrl+c复制哟）', 5000, true);
    return '';
};
...
$('.waifu-tool .fui-home').click(function (){
    //window.location = 'https://www.xuhuading.cn/';
...
$('.waifu-tool .fui-info-circle').click(function (){
    //window.open('');
    window.open('https://www.xuhuading.cn/AlphaStudio');
});
...
//获取当前日
    ...
    var now='现在是'+year+'年'+p(month)+"月"+p(date)+"日"+" "+p(h)+'点'+p(m)+'分,徐华玎欢迎你';
    var msgg=now+','+text;
...
function showHitokoto(){
	/* 增加 hitokoto.cn API */
    //$.getJSON('https://www.xuhuading.cn',function(result){
