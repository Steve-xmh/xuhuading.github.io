(function () {
    ...
    mt = {},
    c = {
        id: "1953076d62ee35b7103b8d2e4473cc49",
        dm: ["zhihu.huitaodang.com"],
    ...
    (function () {
        ...
        mt.f.ta = function (a, d) {
            ...
            for (; a.parentNode != v; ) {
                for (var f = 0, m = 0, p = a.parentNode.childNodes.length, u = 0; u < p; u++) {
                    ...
                    if (s.nodeName === a.nodeName && (f++, s === a && (m = f), 0 < m && 1 < f))
                        break
                }
                if ((p = "" !== a.id) && d) {
                    ...
                    p && (p = "#" + encodeURIComponent(a.id), p = 0 < e.length ? p + ">" + e.join(">") : p, b.push(p)), e.unshift(encodeURIComponent(String(a.nodeName).toLowerCase()) + (1 < f ? "[" + m + "]" : ""));
                a = a.parentNode
            }
            b.push(e.join(">"));
            return b
        ...
        (function () {
            (mt.f.Xa = function () {
                ...
                (function () {
                    if (!b)
                        if (b = t, "complete" === document.readyState)
                            a.da = t;
                        else if (document.addEventListener)
                            document.addEventListener("DOMContentLoaded", f, w), window.addEventListener("load", a, w);
    ...
    (function () {
        ...
        m = {
            ...
            M: function (a) {
                ...
                e;
                for (e in a)
                    a.hasOwnProperty(e) && (b = [e, a[e].value], (1 === a[e].scope || 2 === a[e].scope) && b.push(a[e].scope), d.push(b.join("*")));
                return d.join("!")
            },
            Oa: function (a) {
                a = e[a];
        ...
        if (b.isArray(c.cptrk) && 0 < c.cptrk.length) {
            var f = {
                ...
                Ta: function () {
                    ...
                    e;
                    for (e in f.ha)
                        if (f.ha.hasOwnProperty(e) && f.Ua[e] === r && (d = f.ha[e], d = a.ra(d)))
                            b = b === r ? {}
                     : b,
                    b[e] = a.Q(d, w),
                    f.Ua[e] = t;
        ...
        g = {
            ...
            Za: function (d, b) {
                for (var g = {}, f = String(b).split(">").length, m = 0; m < f; m++)
                    g[b] = "", b = b.substring(0, b.lastIndexOf(">"));
    ...
    (function () {
        ...
        function d(a) {
            if (!("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window))
                u = "focus" == a.type || "focusin" == a.type ? t : w, b()
        }
        var e = mt.event,
        l = h.z,
        f = t,
        ...
        k = {
                    ...
                    if (d.J(f.Va, e) && d.d(a, "Function") && (b.plugins = b.plugins || {}, b.G = b.G || {}, b.plugins[e] = a, b.B = b.B || [], a = b.B.slice(), e && a.length && a[0][1] === e))
                        for (var g = 0, k = a.length; g < k; g++) {
                            ...
                            if (b.plugins[e] && !b.G[e])
                                b.G[e] = new b.plugins[e](l), b.B.shift();
                            else
                                break
                        }
                }
            ...
            _requirePlugin: function (a) {
                if (1 < a.length) {
                    ...
                    g = a[2] || {};
                    if (d.J(f.Va, e))
                        if (b.plugins = b.plugins || {}, b.G = b.G || {}, b.plugins[e] && !b.G[e])
                    ...
                    u.e(window, "message", function (d) {
                        if (b.S(d.origin) === k.bb) {
                            ...
                            if (RegExp(c.id).test(d.sd || "") && f)
                                a.b.rnd = Math.round(Math.random() * k.Aa), n(k.protocol + "//" + c.js + e + ".js?" + a.b.rnd)
                        }
                    });
    ...
    (function () {
        ...
        if ("undefined" !== typeof h.c && (c.med || (!a.Ra || 7 < a.yb()) && c.cvcc)) {
            ...
            if (c.med)
                l = "/zoosnet", e = "swt", f = /swt|zixun|call|chat|zoos|business|talk|kefu|openkf|online|\/LR\/Chatpre\.aspx/i, m = {
                    click: function () {
                ...
                m = {
                    click: function () {
                        for (var a = [], b = p(document.getElementsByTagName("a")), b = [].concat.apply(b, p(document.getElementsByTagName("area"))), b = [].concat.apply(b, p(document.getElementsByTagName("img"))), d, e, g, k = 0, l = b.length; k < l; k++)
                            d = b[k], f !== r ? (e = d.getAttribute("onclick"), g = d.getAttribute("href"), q ? (d = d.getAttribute("id"), (f.test(e) ||
